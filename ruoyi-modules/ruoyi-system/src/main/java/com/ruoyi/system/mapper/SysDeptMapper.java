...
public interface SysDeptMapper extends BaseMapper<SysDept> {
     ...
     * @return 部门列表
     */
    public List<SysDept> selectChildrenDeptById(Integer deptId);
     ...
     * @return 结果
     */
    public int hasChildByDeptId(Integer deptId);
     ...
     * @return 结果
     */
    public SysDept checkDeptNameUnique(@Param("deptName") String deptName, @Param("parentId") Integer parentId);
     ...
     * @param deptIds 部门ID组
     */
    public void updateDeptStatusNormal(Integer[] deptIds);
